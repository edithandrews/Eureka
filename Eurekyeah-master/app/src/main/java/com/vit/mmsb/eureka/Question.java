...
public class Question extends AppCompatActivity {
    ...
    private static final String Q_KEY = "question";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v){
                ...
                String question = simpleEditText.getText().toString();
                ...
                if(dynamicSpinner != null) {
                    ...
                    dynamicSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        ...
                        public void onItemSelected(AdapterView <?> parent, View view,
                            ...
                            Log.d("aaaaaaabbbbbbaaa", (String) parent.getItemAtPosition(position));
                            cat = parent.getItemAtPosition(position).toString();
                        }

                        @Override
                        public void onNothingSelected(AdapterView <?> parent) {
                            Toast toast = Toast.makeText(Question.this, "choose a category, yo!", Toast.LENGTH_SHORT);
                            toast.show();
                        }
                    });
